% 模拟实际磨损深度
function [d_act,iteration]=d_actual(m,n,delta_S,Q1,Q2)
load F.mat
Q1L=floor(Q1*0.5);
Q1R=floor(Q1*0.5)+1;
Q2L=floor(Q2*0.5);
...
% 得到真实数据点
act_dot_1L = produce_dot(Q1L,1,m,n);
act_dot_1R = produce_dot(Q1R,1,m,n);
act_dot_2L = produce_dot(Q2L,0,m,n);
act_dot_2R = produce_dot(Q2R,0,m,n);
